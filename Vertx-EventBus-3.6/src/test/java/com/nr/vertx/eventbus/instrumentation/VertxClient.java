...
public class VertxClient {
	...
	private static final String TRANSACTION1 = "OtherTransaction/EventBus/HandleMessage/news-feed";
	...
	public void sendMessage(EventBus eb) {
		NewRelic.getAgent().getTransaction().setTransactionName(TransactionNamePriority.CUSTOM_HIGH, true, "Test", "SendMessageTest");
