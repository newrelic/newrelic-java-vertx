...
public class VertxClient {
	...
	private static final String TRANSACTION1 = "OtherTransaction/Custom/com.nr.vertx.eventbus.instrumentation.VertxClient/publish";
	...
	public void testSendReceive() {
		...
		String transaction1 = "OtherTransaction/Custom/com.nr.vertx.eventbus.instrumentation.VertxClient/sendMessage";
		assertTrue("Send Message Transaction not found", transactionNames.contains(transaction1));
		String transaction2 = "OtherTransaction/Java/io.vertx.core.eventbus.impl.HandlerRegistration/handle";
